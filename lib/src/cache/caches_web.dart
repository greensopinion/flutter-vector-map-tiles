...
import 'package:vector_map_tiles/src/cache/storage_cache_web.dart';
...
class Caches {
  ...
  late final AbstractStorageCache storageCache;
  ...
  Caches(
      {required TileProviders providers,
        ...
        required Future<String?> Function() cacheStorage}) {
    _storage = ByteStorage();
  ...
  String stats() {
    ...
    cacheStats.add(
        'Storage cache hit ratio:           ${(storageCache as StorageCache).hitRatio.asPct()}%');
    cacheStats.add(
