  ...
  Widget _statusText() => Padding(
      ...
      child: StreamBuilder(
          ...
          builder: (context, snapshot) {
            return Text(
              'Zoom: ${_controller.camera.zoom.toStringAsFixed(2)}'
              'Center: ${_controller.camera.center.latitude.toStringAsFixed(4)},'
              '${_controller.camera.center.longitude.toStringAsFixed(4)}',
            );
          }));
}
